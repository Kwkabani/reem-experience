...
const rooms = [
  { id: 'respect', label: 'غرفة الاحترام', icon: '🤝', title: 'الاحترام', message: 'الاختلاف بيننا ليس تهديدًا لعلاقتنا... بل دليل على أن كل منا يكمل الآخر.\nأحب فيك أنك تحترمين رأيي حتى لو اختلفنا.' },
  { id: 'safety', label: 'غرفة الأمان', icon: '🛡️', title: 'الأمان', message: 'أن تكوني بجانبي لا يعني أنكِ قوية دائمًا.\nالأمان الحقيقي هو أن تعرفي أنكِ تستطيعين الانهيار بجانبي وسأكون لك سندًا.' },
  { id: 'laugh', label: 'غرفة الضحك', icon: '😄', title: 'قوانين البيت', message: 'القانون الأول: الضحك واجب.\nالقانون الثاني: إذا ضحكنا على نفس النكتة ١٠ مرات... نضحك عليها 11 مرة .\nالقانون الثالث: السخافة المتبادلة مسموحة ٢٤ ساعة.' },
  { id: 'space', label: 'غرفة المساحة', icon: '🌙', title: 'المساحة الخاصة', message: 'اذا احتجنا يوما الى بعض الصمت \n فلايعني ذلك اننا توقفنا عن الاهتمام عن بعض \n بل يعني اننا نريد ان نعود لبعض بنسخة افضل من انفسنا 🤍\n ويكون بيننا اتفاق ! \n مش نحول كل صمت الى فيلم , ولا كل تأخير الى قضية 🌚😂' },
  { id: 'support', label: 'غرفة السند', icon: '🤲', title: 'السند', message: 'اشتي تكون فرحتك كانها فرحتي\n وتعبك يكون تعبي \n ويكون معانا مساحة امنه نتكلم عن كل شي بدون خوف \nويكون عندنا ثقة ان محد بيفهم الثاني خطاء' },
];
...
export default function House() {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => setSecretPhase('visible'), 8000);
    return () => clearTimeout(t);
  }, [secretPhase]);
    ...
    <div className="relative min-h-[100dvh] overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute inset-0 opacity-[0.04]"
          style={{
            background: 'repeating-linear-gradient(0deg, transparent 0px, transparent 3px, rgba(255,255,255,0.04) 3px, rgba(255,255,255,0.04) 4px), repeating-linear-gradient(90deg, transparent 0px, transparent 25px, rgba(0,0,0,0.04) 25px, rgba(0,0,0,0.04) 26px)',
          }}
        />
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[20%] opacity-[0.06]"
          style={{
            background: 'repeating-linear-gradient(90deg, transparent 0px, transparent 30px, rgba(201,168,76,0.2) 30px, rgba(201,168,76,0.2) 31px)',
          }}
        />
        <div className="absolute top-[35%] left-1/2 -translate-x-1/2 w-[70%] h-[35%] opacity-[0.12] rounded-full"
      ...
      <StageWrapper stage={Stage.House}>
        <div className="relative z-10 w-full max-w-md mx-auto flex flex-col items-center gap-5 pb-8">
          <GlassCard>
            <p className="text-gold font-display font-bold text-center text-lg">بيتنا المستقبلي 👸🤴</p>
            <p className="text-silver-blue text-center text-sm mt-1">كل غرفة تخبئ رسالة... اختاري باب</p>
          </GlassCard>
          ...
          <div className="self-end mr-3 sm:mr-6"
              ...
              >
                ...
                <div className="w-full max-w-sm">
                  <textarea
                    ...
                    onKeyDown={e => { if (e.key === 'Enter' && !e.shiftKey) { e.preventDefault(); handleQ1Submit(); } }}
                  />
                </div>
                ...
                <GlassCard delay={0.3}>
                  <div className="text-center">
                    ...
                    <p className="text-warm-white font-body leading-relaxed">
                      " يمكن لشخصين ان يبنيا حياة في حال ان قانونهما ليس من الضروري ان نجد شخصًا بلا عيوب...
                      بل أن نجد شخصًا نحترم عيوبه ونحاول فهمه."
                    </p>
                  </div>
                </GlassCard>
                <motion.div
            ...
            {secretPhase === 'question2' && (
              ...
              {q2State === 'choices' && (
                <ChoiceButtons
                  ...
                  onSelect={(value) => { setChosenAnswer(value as 'normal' | 'comedy'); setQ2State('typing'); }}
                />
              )}
      ...
      <AnimatePresence>
        {selectedRoom && (
          ...
          >
            ...
            >
               <div className="absolute opacity-25 rounded-full pointer-events-none"
                 style={{
