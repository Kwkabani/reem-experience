...
export default function FinalMessage() {
  ...
  const openMessage = () => {
    ...
    playSound('click');
    setFlapOpen(true);
    setTimeout(() => setPhase('message'), 700);
  };
  ...
  const handleNo = () => {
    playSound('error');
    setPhase('comedy');
    setTimeout(() => setPhase('final'), 2500);
  };
      ...
      <AnimatePresence mode="wait">
        {phase === 'intro' && (
          ...
          >
            ...
            >
              <SystemMessage text="يله افتحي الظرف عشان نقرا اخر رساله" speed={30} delay={0} prefix />
            </motion.div>
              ...
              >
                ...
                <div className="relative w-full h-full bg-[#e8d5b0] rounded-lg border-2 border-[#c4a87a] overflow-hidden shadow-xl">
                  <div className="absolute inset-0 opacity-[0.08]"
                    style={{
                      backgroundImage: 'repeating-linear-gradient(0deg, transparent 0px, transparent 1px, rgba(0,0,0,0.1) 1px, rgba(0,0,0,0.1) 2px), repeating-linear-gradient(90deg, transparent 0px, transparent 15px, rgba(0,0,0,0.04) 15px, rgba(0,0,0,0.04) 16px)',
                    }}
                  />

                  <div className="absolute top-0 left-0 right-0 h-[45%] opacity-60"
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                    style={{ background: 'radial-gradient(ellipse at 50% 40%, rgba(201,168,76,0.08), transparent 70%)' }}
                  />
                </div>
              </div>
            </motion.div>
          ...
          >
            <LoveCard variant="message" delay={0.2}>
              ...
              <div className="space-y-4 text-right">
                ...
                <p className="text-warm-white font-body leading-relaxed">
                  في الأيام اللي تضحكي فيها، والأيام اللي تحتاجي فيها تفضفض،
                  والأيام اللي تحسي أنش تحتاجي تسكتي.
                </p>
                <p className="text-warm-white font-body leading-relaxed">
                  أنا هنا. مش شرط يكون عندي كل الإجابات...
                  بس عندي قلب يشتي يفهمش اكثر واكثر ؛ ويتعمق في كل تفاصيلش .
                </p>
                <p className="text-warm-white font-body leading-relaxed">
                  الحياة صح مش سهلة، لكنها تصبح أسهل لما تعرف أن في شخص واحد في الدنيا هذا
                  يوقف معك مهما صار.
                </p>
                <p className="text-warm-white font-body leading-relaxed">
                  أنا شوقع لش هذا الشخص ؛ بدون تكلف وبدون اي مبالغة
                  -----------------------------------------------------
                  اخترت الطريقة هذه عشان يكون الكلام هذا مفاجئة لش واتمنى انو اليوم هذا يكون سبب في فرحتنا كل سنة ؛ ونجلس نتذكر كل لحظة كل سنة باذن الله
                </p>
          ...
          >
            ...
            <GlassCard delay={0.2}>
              <p className="text-warm-white text-center leading-relaxed">
                ...
                <br />
                <span className="text-silver-blue text-sm">
                  بس نعرف أن الجواب الصح هو... ❤️
                </span>
              </p>
            </GlassCard>
          </motion.div>
        ...
        {phase === 'final' && (
          ...
          >
            ...
            <LoveCard variant="final" delay={0.5}>
              ...
              <p className="text-warm-white text-center font-body leading-relaxed">
                ونعم للأبد.
              </p>
            </LoveCard>
            ...
            <motion.div
              ...
              className="mt-8"
            >
              <p className="text-silver-blue/50 text-sm font-mono">
                سنة حب ❤️ 10-07-2026
              </p>
              <p className="text-silver-blue/30 text-xs mt-1 font-mono">
